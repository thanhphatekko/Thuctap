    ...
    <div>
        ...
        <div className="product-grid">
          <div className="product-item category">
            ...
            <div className="product-info">
              ...
              <p>
                <del>AED 32.00</del>
                <span className="discounted-price">AED 25.60</span>
          ...
          <div className="product-item skin-care">
            <div className="product-image">
              <button className="categorys">Category</button>
            </div>
            <div className="product-info">
      ...
      <div className="ambassador-container">
        <div className="ambassador">
          ...
          <button className="shop-with-me">SHOP WITH ME</button>
        </div>
        <div className="ambassador">
          <div className="avatar"></div>
          <h2 className="name">Name Surname</h2>
